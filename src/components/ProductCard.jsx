      ...
      <div className="flex flex-1 flex-col gap-3 px-4 pb-4 pt-3">
        ...
        <div className="mt-auto flex items-center justify-between gap-3">
          ...
          <button
            ...
            onClick={handleAdd}
            disabled={!inStock}
            className={`inline-flex items-center justify-center gap-1 whitespace-nowrap flex-shrink-0 rounded-xl px-3 py-1.5 text-xs font-semibold shadow-sm transition ${
              inStock
